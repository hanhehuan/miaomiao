    ...
    <div id="main">
        ...
        <Header title="喵喵电影"/>
            <div id="content">
                    ...
                    <router-link tag="div" to="/movie/search" class="search_entity">
...
<style scoped>
    ...
    .movie_menu .search_entity{ margin-right:20px; height:100%; line-height: 45px;}
    .movie_menu .search_entity.active{ color: #ef4238; border-bottom: 2px #ef4238 solid;}
    .movie_menu .search_entity.router-link-active{ color: #ef4238; border-bottom: 2px #ef4238 solid;}
